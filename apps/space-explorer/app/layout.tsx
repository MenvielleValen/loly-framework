...
export default function RootLayout(props: LayoutProps) {
  ...
  return (
    <ThemeProvider initialTheme={theme}>
      {/* Minimalist Global Header - Clean and Simple */}
      <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm">
        <nav className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[linear-gradient(135deg,oklch(0.7_0.25_200),oklch(0.75_0.2_180))]">
